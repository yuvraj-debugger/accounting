            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form accept-charset="utf-8" action="{{route('account.store')}}" method="POST">
                                @csrf
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="parent_account_name" placeholder="Account Type" class="form-control all-select2_dropdown">
                                        ...
                                        <option value="{{$account->id}}" {{(old('parent_account_name') == $account->id)?'selected':''}}>{{$account->name}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="opening_balance" placeholder="Opening Balance" class="form-control" value="{{!empty(old('opening_balance'))?old('opening_balance'):''}}">
